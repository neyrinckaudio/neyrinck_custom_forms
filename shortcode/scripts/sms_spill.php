...
?>
    <iframe style='border:0' width=0 height=0 src=<?php echo $url; ?>></iframe>
    <h1>THANK YOU FOR DOWNLOADING SPILL</h1>
    <hr/>
<?php
   ...
   try {
      ...
      $client2->messages->create(
          ...
          array(
              ...
              'body' => "Get V-PlugIn for free at the App Store. https://itunes.apple.com/us/app/v-plugin/id1155577312"
          )
      );

      $url = 'https://neyrinck.com/products/spill/a-text-message-is-on-the-way/';
      error_log($url, 1, "berniceling@neyrinck.com");
      ob_start();
      header('Location: '.$url);
      ob_end_flush();
      die();
...
<p style='font-weight: bold; font-size:1.2em;  padding:20px; margin-left: 20px; margin-right: 20px; '>Take control of Spill with the V-PlugIn app for iPhone and iPad.</p>
<p>Enter your phone number below and we will message an App Store link to you for V-Plugin on your iPhone and iPad. V-Plugin is a <b>free</b> download</p>
...
<div class='floatLeft50 PaddingTop6EmForDesktop'><img src="https://neyrinck.com/wp-content/uploads/2016/09/Neyrinck_V-PlugIn_iPad_iPhone_Spill.jpg" alt="V-PlugIn iPad iPhone Controlling Spill" >
</div>
    ...
    <td colspan="2">
      <div style='padding: 2em 0em; width: 277px; margin: 0 auto;'>
        ...
        <p style='text-align: center;'>
          <a style='font-weight: bold' href="https://neyrinck.com/products/spill/features/#pm">Not Now</a>
        </p>
      </div>
    </td>
  </tr>

...
if ($_POST['submit'] == 'Send') {
  ...
  if ($result = '1')
  {
    ...
    echo "There is an error subscribing. Please try again later.";
  }
...
<div style='padding: 2em 0em; width: 27em; margin: 0 auto;' class="g-recaptcha" data-sitekey="6LfiXuISAAAAALP4gpHG-9yuN_xc1X0IN3AIuxpI"></div>
  </div>
  </td>
</tr>
...
<script src="/scripts/contactus_form.js"></script>
